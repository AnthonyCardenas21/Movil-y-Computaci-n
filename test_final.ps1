...
try {
    ...
    $doctorData = @'
{"email":"doctor@hospital.com","password":"doctor123","first_name":"Dr. Carlos","last_name":"Mendoza","role":"médico"}
'@
...
try {
    $patientData = @'
{"email":"paciente@email.com","password":"paciente123","first_name":"Ana","last_name":"Garcia","role":"paciente"}
'@
